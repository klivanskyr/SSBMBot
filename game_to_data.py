...
post_state_features = [
    ...
    # 'p0_leader_post_misc_as_0', do not really need these for the model
    # 'p0_leader_post_misc_as_1',
    # 'p0_leader_post_misc_as_2',
    # 'p0_leader_post_misc_as_3',
    ...
    # 'p0_leader_post_state_flags_0', do not really need these for the model
    # 'p0_leader_post_state_flags_1',
    # 'p0_leader_post_state_flags_2',
    # 'p0_leader_post_state_flags_3',
    # 'p0_leader_post_state_flags_4',
    ...
    # 'p1_leader_post_misc_as_0', do not really need these for the model
    # 'p1_leader_post_misc_as_1',
    # 'p1_leader_post_misc_as_2',
    # 'p1_leader_post_misc_as_3',
    ...
    # 'p1_leader_post_state_flags_0', do not really need these for the model
    # 'p1_leader_post_state_flags_1',
    # 'p1_leader_post_state_flags_2',
    # 'p1_leader_post_state_flags_3',
    # 'p1_leader_post_state_flags_4',
